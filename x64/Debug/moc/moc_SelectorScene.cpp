...
const QMetaObject SelectorScene::staticMetaObject = {
    { &QGraphicsScene::staticMetaObject, qt_meta_stringdata_SelectorScene.data,
      qt_meta_data_SelectorScene,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SelectorScene::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SelectorScene.stringdata0))
        return static_cast<void*>(const_cast< SelectorScene*>(this));
