...
void MouseEventRectItem::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MouseEventRectItem *_t = static_cast<MouseEventRectItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (MouseEventRectItem::*_t)(QGraphicsSceneMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEventRectItem::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MouseEventRectItem::*_t)(QGraphicsSceneHoverEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEventRectItem::hoverEntered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MouseEventRectItem::*_t)(QGraphicsSceneHoverEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEventRectItem::hoverMoved)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (MouseEventRectItem::*_t)(QGraphicsSceneHoverEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEventRectItem::hoverLeft)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject MouseEventRectItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MouseEventRectItem.data,
      qt_meta_data_MouseEventRectItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MouseEventRectItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MouseEventRectItem.stringdata0))
        return static_cast<void*>(const_cast< MouseEventRectItem*>(this));
    if (!strcmp(_clname, "QGraphicsRectItem"))
        return static_cast< QGraphicsRectItem*>(const_cast< MouseEventRectItem*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MouseEventPixmapItem *_t = static_cast<MouseEventPixmapItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->clicked((*reinterpret_cast< QGraphicsSceneMouseEvent*(*)>(_a[1]))); break;
        case 1: _t->hoverEntered((*reinterpret_cast< QGraphicsSceneHoverEvent*(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (MouseEventPixmapItem::*_t)(QGraphicsSceneMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEventPixmapItem::clicked)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MouseEventPixmapItem::*_t)(QGraphicsSceneHoverEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEventPixmapItem::hoverEntered)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MouseEventPixmapItem::*_t)(QGraphicsSceneHoverEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEventPixmapItem::hoverMoved)) {
                *result = 2;
                return;
            }
        }
        {
            typedef void (MouseEventPixmapItem::*_t)(QGraphicsSceneHoverEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MouseEventPixmapItem::hoverLeft)) {
                *result = 3;
                return;
            }
        }
...
const QMetaObject MouseEventPixmapItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MouseEventPixmapItem.data,
      qt_meta_data_MouseEventPixmapItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MouseEventPixmapItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MouseEventPixmapItem.stringdata0))
        return static_cast<void*>(const_cast< MouseEventPixmapItem*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< MouseEventPixmapItem*>(this));
    return QObject::qt_metacast(_clname);
}
...
const QMetaObject HoverChangedPixmapItem::staticMetaObject = {
    { &MouseEventPixmapItem::staticMetaObject, qt_meta_stringdata_HoverChangedPixmapItem.data,
      qt_meta_data_HoverChangedPixmapItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *HoverChangedPixmapItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_HoverChangedPixmapItem.stringdata0))
        return static_cast<void*>(const_cast< HoverChangedPixmapItem*>(this));
...
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        MoviePixmapItem *_t = static_cast<MoviePixmapItem *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (MoviePixmapItem::*_t)(QGraphicsSceneMouseEvent * );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MoviePixmapItem::click)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (MoviePixmapItem::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MoviePixmapItem::loopStarted)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (MoviePixmapItem::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&MoviePixmapItem::finished)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject MoviePixmapItem::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_MoviePixmapItem.data,
      qt_meta_data_MoviePixmapItem,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MoviePixmapItem::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MoviePixmapItem.stringdata0))
        return static_cast<void*>(const_cast< MoviePixmapItem*>(this));
    if (!strcmp(_clname, "QGraphicsPixmapItem"))
        return static_cast< QGraphicsPixmapItem*>(const_cast< MoviePixmapItem*>(this));
    return QObject::qt_metacast(_clname);
}
